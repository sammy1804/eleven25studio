...
function GalleryScene({
  ...
  // Auto-play only — no wheel/keyboard capture so page scroll works normally

  useFrame((state, delta) => {
    // Always auto-play — steady forward drift
...
function FallbackGallery({ images }: { images: ImageItem[] }) {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-full bg-[#F5F1EA] p-4">
