        ...
        <div className="mt-6 flex items-center justify-center gap-3">
              ...
              return (
                <button
                  ...
                  className={cn(
                    ...
                    on ? 'bg-[#0A0A0A] w-5' : 'bg-[#0A0A0A]/25 hover:bg-[#0A0A0A]/50'
                  )}
          ...
          {activeItem.href && (
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="text-[#0A0A0A]/40 hover:text-[#0A0A0A] transition"
    ...
    <div className="relative h-full w-full">
      <div className="absolute inset-0">
        {item.imageSrc ? (
          ...
          <div className="flex h-full w-full items-center justify-center bg-[#E8E4DD] text-sm text-[#0A0A0A]/40">
            No image
          </div>
        )}
      </div>
      ...
      <div className="relative z-10 flex h-full flex-col justify-end p-5">
        ...
        {item.tag && (
          <div className="mt-2 inline-block text-[10px] tracking-widest uppercase text-white/60">
            {item.tag}
          </div>
        )}
      </div>
