...
export default function ArchContactStrip() {
  ...
  return (
    <section style={{ background: '#F5F4F1', padding: '80px clamp(40px, 6vw, 100px)' }}>
      <div
        ref={ref}
        style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 'clamp(40px, 6vw, 80px)', alignItems: 'center', maxWidth: 1200, margin: '0 auto' }}
      >
        {/* Left */}
        <div>
          <motion.p
        ...
        >
          {/* Filled pill */}
          <a
            href="mailto:hello@eleven25studios.com?subject=Book a Shoot"
            style={{
              display: 'inline-flex',
              alignItems: 'center',
              gap: 8,
          ...
          {/* Outline pill */}
          <a
            href="mailto:hello@eleven25studios.com?subject=Request Portfolio"
            style={{
              display: 'inline-flex',
              alignItems: 'center',
              gap: 8,
