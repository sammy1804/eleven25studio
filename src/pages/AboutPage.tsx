...
function ProjectCard({
  ...
  return (
    ...
    >
      {/* Image */}
      <div style={{ order: isMobile ? 1 : (isEven ? 1 : 2), overflow: 'hidden' }}>
        <motion.img
          src={project.img}
          alt={project.name}
          style={{
            y: isMobile ? 0 : imgY,
            width: '100%',
            height: isMobile ? '56vw' : 'clamp(260px, 32vw, 480px)',
            objectFit: 'cover',
            display: 'block',
      ...
      {/* Text */}
      <div style={{ order: isMobile ? 2 : (isEven ? 2 : 1) }}>
        <p
          style={{
            fontFamily: "'Space Mono', monospace",
            fontSize: 10,
        ...
        <h3
          style={{
            fontFamily: "-apple-system, BlinkMacSystemFont, 'SF Pro Display', 'Helvetica Neue', sans-serif",
            fontSize: isMobile ? 'clamp(24px, 7vw, 36px)' : 'clamp(28px, 3.5vw, 50px)',
            fontWeight: 300,
            lineHeight: 1.1,
            color: T.ink,
            marginBottom: '1rem',
        ...
        <div style={{ borderLeft: `2px solid ${T.accent}`, paddingLeft: '1.25rem', maxWidth: 380 }}>
          <p style={{ fontFamily: "'Nunito', sans-serif", fontSize: 12, lineHeight: 1.7, color: T.muted, margin: 0 }}>
    ...
    >
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
        <img
          src={t.img}
          alt={t.name}
          style={{ width: 40, height: 40, borderRadius: '50%', objectFit: 'cover', filter: 'grayscale(20%)', flexShrink: 0 }}
        />
        <div>
          <p style={{ fontFamily: "'Nunito', sans-serif", fontSize: 13, fontWeight: 600, color: T.ink, margin: 0 }}>
            {t.name}
          </p>
          <p style={{ fontFamily: "'Nunito', sans-serif", fontSize: 11, color: T.muted, margin: 0 }}>
            {t.role} — {t.company}
          </p>
        </div>
      </div>
...
/* ── Stacking testimonials — simple list on mobile ── */
function StackingTestimonials() {
  ...
  if (isMobile) {
    return (
      <div style={{ background: T.bgAlt, padding: '4rem 1.5rem' }}>
    ...
    <div ref={containerRef} style={{ height: '300vh', background: T.bgAlt }}>
      ...
      >
        ...
        <div style={{ position: 'relative', maxWidth: 740, width: '100%' }}>
          <motion.div style={{ scale: scale1, transformOrigin: 'top center', position: 'relative', zIndex: 1 }}>
            <TestimonialCard t={TESTIMONIALS[0]} />
          </motion.div>
          <motion.div style={{ position: 'absolute', top: 0, left: 0, right: 0, y: y2, scale: scale2, transformOrigin: 'top center', zIndex: 2 }}>
            <TestimonialCard t={TESTIMONIALS[1]} />
          </motion.div>
          <motion.div style={{ position: 'absolute', top: 0, left: 0, right: 0, y: y3, zIndex: 3 }}>
    ...
    <main style={{ background: T.bg, minHeight: '100vh' }}>
      ...
      <section
        ...
        style={{
          ...
          alignItems: 'center',
          paddingTop: isMobile ? 'clamp(6rem, 12vh, 8rem)' : 'clamp(7rem, 12vh, 10rem)',
          paddingBottom: '4rem',
          paddingLeft: 'clamp(1.5rem, 5vw, 5rem)',
          paddingRight: isMobile ? 'clamp(1.5rem, 5vw, 5rem)' : 0,
        ...
        <div style={{ paddingRight: isMobile ? 0 : '2rem' }}>
          ...
          <Reveal delay={0.08}>
            <h1
              style={{
                fontFamily: "-apple-system, BlinkMacSystemFont, 'SF Pro Display', 'Helvetica Neue', sans-serif",
                fontSize: isMobile ? 'clamp(32px, 9vw, 56px)' : 'clamp(40px, 5.5vw, 80px)',
                fontWeight: 300,
                lineHeight: 1.08,
                color: T.ink,
          ...
          <Reveal delay={0.16}>
            <p style={{ fontFamily: "'Nunito', sans-serif", fontSize: 15, lineHeight: 1.8, color: T.muted, maxWidth: 420, marginBottom: '2.5rem' }}>
      ...
      >
        ...
        >
          {/* Narrative */}
          <div>
            <Reveal><Label>My Story</Label></Reveal>
            <Reveal delay={0.06}>
              <blockquote
                style={{
                  fontFamily: "-apple-system, BlinkMacSystemFont, 'SF Pro Display', 'Helvetica Neue', sans-serif",
                  fontSize: isMobile ? 'clamp(22px, 6vw, 32px)' : 'clamp(28px, 3.5vw, 46px)',
                  fontWeight: 300,
                  fontStyle: 'italic',
                  lineHeight: 1.3,
                  color: T.ink,
            ...
            <Reveal delay={0.12}>
              <p style={{ fontFamily: "'Nunito', sans-serif", fontSize: 14, lineHeight: 1.85, color: T.muted, marginBottom: '1.5rem' }}>
            ...
            <Reveal delay={0.18}>
              <p style={{ fontFamily: "'Nunito', sans-serif", fontSize: 14, lineHeight: 1.85, color: T.muted, marginBottom: '1.5rem' }}>
                ...
                corporate campaigns, and cinematic wedding work.
              </p>
            </Reveal>
            <Reveal delay={0.24}>
              <p style={{ fontFamily: "'Nunito', sans-serif", fontSize: 14, lineHeight: 1.85, color: T.muted }}>
          ...
          <div style={{ overflow: 'hidden', borderRadius: 2 }}>
            <motion.img
              ...
              alt="Studio at work"
              style={{
                y: isMobile ? 0 : storyImgY,
                scale: isMobile ? 1 : storyImgScale,
                width: '100%',
                height: isMobile ? '65vw' : 'clamp(420px, 55vh, 680px)',
                objectFit: 'cover',
                display: 'block',
                filter: 'brightness(0.88) saturate(0.85)',
              }}
      ...
      <section
        style={{
          borderTop: `1px solid ${T.border}`,
          padding: 'clamp(4rem, 9vh, 8rem) clamp(1.5rem, 5vw, 5rem)',
          background: T.bg,
        }}
      >
                ...
                <Reveal key={stat.label} delay={i * 0.07}>
                  ...
                  >
                    <span
                      style={{
                        fontFamily: "-apple-system, BlinkMacSystemFont, 'SF Pro Display', 'Helvetica Neue', sans-serif",
                        fontSize: isMobile ? 'clamp(36px, 10vw, 60px)' : 'clamp(52px, 6vw, 80px)',
                        fontWeight: 300,
                        color: T.ink,
                        lineHeight: 1,
                        display: 'block',
      ...
      >
        <div
          style={{
            ...
            gap: isMobile ? '2rem' : 'clamp(3rem, 7vw, 8rem)',
            maxWidth: 1280,
            margin: '0 auto',
            alignItems: 'start',
          }}
        >
          {/* Heading — sticky on desktop only */}
          <div style={{ position: isMobile ? 'relative' : 'sticky', top: isMobile ? undefined : '30vh' }}>
            <Reveal>
              <Label>How I Work</Label>
              <h2
                style={{
                  fontFamily: "-apple-system, BlinkMacSystemFont, 'SF Pro Display', 'Helvetica Neue', sans-serif",
                  fontSize: isMobile ? 'clamp(28px, 8vw, 42px)' : 'clamp(32px, 4vw, 54px)',
                  fontWeight: 300,
                  lineHeight: 1.2,
                  color: T.ink,
              ...
              <p style={{ fontFamily: "'Nunito', sans-serif", fontSize: 13, lineHeight: 1.8, color: T.muted, maxWidth: 280 }}>
      ...
      <section
        style={{
          background: T.bgDark,
          padding: 'clamp(5rem, 12vh, 11rem) clamp(1.5rem, 7vw, 7rem)',
        }}
      >
        <Reveal>
          <p
            ...
            <Reveal key={bold} delay={i * 0.1}>
              ...
              >
                <p
                  style={{
                    fontFamily: "-apple-system, BlinkMacSystemFont, 'SF Pro Display', 'Helvetica Neue', sans-serif",
                    fontSize: isMobile ? 'clamp(28px, 9vw, 52px)' : 'clamp(36px, 5.5vw, 76px)',
                    fontWeight: 300,
                    lineHeight: 1.1,
      ...
      <section
        style={{
          background: T.bg,
          borderTop: `1px solid ${T.border}`,
          padding: 'clamp(5rem, 15vh, 13rem) clamp(1.5rem, 5vw, 5rem)',
          textAlign: 'center',
        }}
      >
        ...
        <Reveal delay={0.08}>
          <h2
            style={{
              fontFamily: "-apple-system, BlinkMacSystemFont, 'SF Pro Display', 'Helvetica Neue', sans-serif",
              fontSize: isMobile ? 'clamp(32px, 10vw, 56px)' : 'clamp(40px, 6vw, 88px)',
              fontWeight: 300,
              lineHeight: 1.08,
              color: T.ink,
        ...
        <Reveal delay={0.14}>
          <p style={{ fontFamily: "'Nunito', sans-serif", fontSize: 15, lineHeight: 1.8, color: T.muted, maxWidth: 440, margin: '0 auto 3rem' }}>
